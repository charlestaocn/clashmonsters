      ...
      _export("EnemyManager", EnemyManager = (_dec = ccclass("EnemyManager"), _dec2 = property(_crd && EnemySpawner === void 0 ? (_reportPossibleCrUseOfEnemySpawner({
        ...
        init(targetNode, settings) {
          ...
          for (const individualSpawnerSettings of settings.individualEnemySpawners) {
            const individualSpawner = new (_crd && IndividualEnemySpawner === void 0 ? (_reportPossibleCrUseOfIndividualEnemySpawner({
              error: Error()
          ...
          for (const circularSpawnerSettings of settings.circularEnemySpawners) {
            const circularSpawner = new (_crd && CircularEnemySpawner === void 0 ? (_reportPossibleCrUseOfCircularEnemySpawner({
              error: Error()
          ...
          for (const waveSpawnerSettings of settings.waveEnemySpawners) {
            const waveSpawner = new (_crd && WaveEnemySpawner === void 0 ? (_reportPossibleCrUseOfWaveEnemySpawner({
              error: Error()
...
//# sourceMappingURL=09b6cf92d452cceb235aac5e7195b543fe5960df.js.map