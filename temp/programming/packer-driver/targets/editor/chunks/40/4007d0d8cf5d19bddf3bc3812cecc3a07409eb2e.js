    ...
    execute: function () {
      ...
      _export("UpgradesModalWindow", UpgradesModalWindow = (_dec = ccclass("UpgradesModalWindow"), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(AudioClip), _dec(_class = (_class2 = class UpgradesModalWindow extends (_crd && ModalWindow === void 0 ? (_reportPossibleCrUseOfModalWindow({
        ...
        setup() {
          ...
          const settings = (_crd && AppRoot === void 0 ? (_reportPossibleCrUseOfAppRoot({
            error: Error()
        ...
        createUpgradeButton(upgradeType, upgradeSettings, levelKey) {
          const upgradeButton = instantiate(this.upgradeButtonPrefab);
          const upgradeUI = upgradeButton.getComponent(_crd && UpgradeUI === void 0 ? (_reportPossibleCrUseOfUpgradeUI({
            error: Error()
          }), UpgradeUI) : UpgradeUI);
        ...
        tryUpgrade(upgradeType) {
          ...
          const costs = this.typeToCosts.get(upgradeType);
          const currentLevel = this.typeToLevel.get(upgradeType);
...
//# sourceMappingURL=4007d0d8cf5d19bddf3bc3812cecc3a07409eb2e.js.map