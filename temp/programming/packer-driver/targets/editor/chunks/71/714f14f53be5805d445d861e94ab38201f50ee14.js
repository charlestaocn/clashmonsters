  ...
  return {
    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass("Game"), _dec2 = property(_crd && VirtualJoystic === void 0 ? (_reportPossibleCrUseOfVirtualJoystic({
        ...
        async play(userData, settings, translationData, testValues) {
          ...
          while (!this.gameResult.hasExitManually && this.player.Health.IsAlive) await (_crd && delay === void 0 ? (_reportPossibleCrUseOfdelay({
            error: Error()
          }), delay) : delay)(100);
        ...
        async setup(userData, settings, translationData, testValues) {
          await (_crd && requireAppRootAsync === void 0 ? (_reportPossibleCrUseOfrequireAppRootAsync({
            error: Error()
          }), requireAppRootAsync) : requireAppRootAsync)();
          this.gameCanvas.cameraComponent = (_crd && AppRoot === void 0 ? (_reportPossibleCrUseOfAppRoot({
            error: Error()
          }), AppRoot) : AppRoot).Instance.MainCamera;
          this.gameResult = new GameResult();
          const metaUpgrades = new (_crd && MetaUpgrades === void 0 ? (_reportPossibleCrUseOfMetaUpgrades({
            error: Error()
          }), MetaUpgrades) : MetaUpgrades)(userData.game.metaUpgrades, settings.metaUpgrades);
          this.virtualJoystic.init();
          const wasd = new (_crd && KeyboardInput === void 0 ? (_reportPossibleCrUseOfKeyboardInput({
            error: Error()
          }), KeyboardInput) : KeyboardInput)(KeyCode.KEY_W, KeyCode.KEY_S, KeyCode.KEY_A, KeyCode.KEY_D);
          const arrowKeys = new (_crd && KeyboardInput === void 0 ? (_reportPossibleCrUseOfKeyboardInput({
            error: Error()
          }), KeyboardInput) : KeyboardInput)(KeyCode.ARROW_UP, KeyCode.ARROW_DOWN, KeyCode.ARROW_LEFT, KeyCode.ARROW_RIGHT);
          const multiInput = new (_crd && MultiInput === void 0 ? (_reportPossibleCrUseOfMultiInput({
            error: Error()
          }), MultiInput) : MultiInput)([this.virtualJoystic, wasd, arrowKeys]);
          ...
          this.playerCollisionSystem = new (_crd && PlayerCollisionSystem === void 0 ? (_reportPossibleCrUseOfPlayerCollisionSystem({
            error: Error()
          }), PlayerCollisionSystem) : PlayerCollisionSystem)(this.player, settings.player.collisionDelay, this.itemManager);
          new (_crd && WeaponCollisionSystem === void 0 ? (_reportPossibleCrUseOfWeaponCollisionSystem({
            error: Error()
          }), WeaponCollisionSystem) : WeaponCollisionSystem)(this.player.Weapon);
          const projectileData = new (_crd && ProjectileData === void 0 ? (_reportPossibleCrUseOfProjectileData({
            error: Error()
          ...
          this.haloProjectileLauncher = new (_crd && HaloProjectileLauncher === void 0 ? (_reportPossibleCrUseOfHaloProjectileLauncher({
            error: Error()
          }), HaloProjectileLauncher) : HaloProjectileLauncher)(this.haloProjectileLauncherComponent, this.player.node, settings.player.haloLauncher, projectileData);
          this.horizontalProjectileLauncher = new (_crd && WaveProjectileLauncher === void 0 ? (_reportPossibleCrUseOfWaveProjectileLauncher({
            error: Error()
          }), WaveProjectileLauncher) : WaveProjectileLauncher)(this.horizontalProjectileLauncherComponent, this.player.node, [new Vec2(0, 1), new Vec2(-0.1, 0.8), new Vec2(0.1, 0.8)], settings.player.horizontalLauncher, projectileData);
          this.diagonalProjectileLauncher = new (_crd && WaveProjectileLauncher === void 0 ? (_reportPossibleCrUseOfWaveProjectileLauncher({
            error: Error()
          }), WaveProjectileLauncher) : WaveProjectileLauncher)(this.diagonalProjectileLauncherComponent, this.player.node, [new Vec2(-0.5, -0.5), new Vec2(0.5, -0.5)], settings.player.diagonalLauncher, projectileData);
          this.enemyAxeProjectileLauncher = new (_crd && EnemyProjectileLauncher === void 0 ? (_reportPossibleCrUseOfEnemyProjectileLauncher({
            error: Error()
          }), EnemyProjectileLauncher) : EnemyProjectileLauncher)(this.enemyAxeProjectileLauncherComponent, this.player.node, this.enemyManager, settings.enemyManager.axeLauncher);
          this.enemyMagicOrbProjectileLauncher = new (_crd && EnemyProjectileLauncher === void 0 ? (_reportPossibleCrUseOfEnemyProjectileLauncher({
            error: Error()
          }), EnemyProjectileLauncher) : EnemyProjectileLauncher)(this.enemyMagicOrbProjectileLauncherComponent, this.player.node, this.enemyManager, settings.enemyManager.magicOrbLauncher);
          new (_crd && PlayerProjectileCollisionSystem === void 0 ? (_reportPossibleCrUseOfPlayerProjectileCollisionSystem({
            error: Error()
          }), PlayerProjectileCollisionSystem) : PlayerProjectileCollisionSystem)([this.haloProjectileLauncher, this.horizontalProjectileLauncher, this.diagonalProjectileLauncher]);
          this.itemAttractor = new (_crd && ItemAttractor === void 0 ? (_reportPossibleCrUseOfItemAttractor({
            error: Error()
          }), ItemAttractor) : ItemAttractor)(this.player.node, 100);
          new (_crd && MagnetCollisionSystem === void 0 ? (_reportPossibleCrUseOfMagnetCollisionSystem({
            error: Error()
          }), MagnetCollisionSystem) : MagnetCollisionSystem)(this.player.Magnet, this.itemAttractor);
          const upgrader = new (_crd && Upgrader === void 0 ? (_reportPossibleCrUseOfUpgrader({
            error: Error()
          }), Upgrader) : Upgrader)(this.player, this.horizontalProjectileLauncher, this.haloProjectileLauncher, this.diagonalProjectileLauncher, settings.upgrades);
          const modalLauncher = new (_crd && GameModalLauncher === void 0 ? (_reportPossibleCrUseOfGameModalLauncher({
            error: Error()
          }), GameModalLauncher) : GameModalLauncher)((_crd && AppRoot === void 0 ? (_reportPossibleCrUseOfAppRoot({
            error: Error()
          }), AppRoot) : AppRoot).Instance.ModalWindowManager, this.player, this.gamePauser, upgrader, translationData);
          ...
          this.gameAudioAdapter.init(this.player, this.enemyManager, this.itemManager, this.horizontalProjectileLauncher, this.diagonalProjectileLauncher, this.haloProjectileLauncher);
        }

        createPlayerData(settings, metaUpgrades) {
          const playerData = Object.assign(new (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
...
//# sourceMappingURL=714f14f53be5805d445d861e94ab38201f50ee14.js.map