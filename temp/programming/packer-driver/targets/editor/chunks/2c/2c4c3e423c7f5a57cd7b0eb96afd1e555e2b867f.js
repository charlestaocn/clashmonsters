  ...
  return {
    ...
    execute: function () {
      ...
      _export("LevelUpModalWindow", LevelUpModalWindow = (_dec = ccclass("LevelUpModalWindow"), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = class LevelUpModalWindow extends (_crd && ModalWindow === void 0 ? (_reportPossibleCrUseOfModalWindow({
        ...
        async setup(params) {
          const shuffledAvailableUpgrades = (_crd && shuffle === void 0 ? (_reportPossibleCrUseOfshuffle({
            error: Error()
          ...
          for (let i = 0; i < shuffledAvailableUpgrades.length; i++) {
            ...
            const skill = instantiate(this.skillPrefab).getComponent(_crd && LevelUpSkill === void 0 ? (_reportPossibleCrUseOfLevelUpSkill({
              error: Error()
...
//# sourceMappingURL=2c4c3e423c7f5a57cd7b0eb96afd1e555e2b867f.js.map