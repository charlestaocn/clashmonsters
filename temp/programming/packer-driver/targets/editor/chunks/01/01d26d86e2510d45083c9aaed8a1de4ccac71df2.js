    ...
    execute: function () {
      ...
      _export("ModalWindow", ModalWindow = (_dec = property(Animation), _dec2 = property(_crd && UIButton === void 0 ? (_reportPossibleCrUseOfUIButton({
        ...
        async runAsync(params) {
          ...
          (_this$closeButton = this.closeButton) == null ? void 0 : _this$closeButton.InteractedEvent.on(() => this.dismiss(), this);
          (_this$backgroundClose = this.backgroundCloseButton) == null ? void 0 : _this$backgroundClose.InteractedEvent.on(() => this.dismiss(), this);
          this.setup(params);
          (_this$animation = this.animation) == null ? void 0 : _this$animation.play(this.openAnimationName);

          while (!this.isDismissed) await (_crd && delay === void 0 ? (_reportPossibleCrUseOfdelay({
            error: Error()
          }), delay) : delay)(100);

          (_this$animation2 = this.animation) == null ? void 0 : _this$animation2.play(this.closeAnimationName);
          await (_crd && delay === void 0 ? (_reportPossibleCrUseOfdelay({
            error: Error()
          }), delay) : delay)(this.getCloseAnimationTime() * 1000);
          return this.result;
        }
        ...
        getCloseAnimationTime() {
          ...
          const state = (_this$animation3 = this.animation) == null ? void 0 : _this$animation3.getState(this.closeAnimationName);
...
//# sourceMappingURL=01d26d86e2510d45083c9aaed8a1de4ccac71df2.js.map