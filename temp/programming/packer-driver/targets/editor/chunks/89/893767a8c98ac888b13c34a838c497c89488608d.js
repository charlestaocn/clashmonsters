      ...
      _export("EnemySpawner", EnemySpawner = (_dec = ccclass("EnemySpawner"), _dec2 = property(Prefab), _dec(_class = (_class2 = class EnemySpawner extends Component {
        ...
        init(targetNode, enemiesSettings) {
          ...
          for (const enemy of this.enemies) {
            const enemyPool = new (_crd && ObjectPool === void 0 ? (_reportPossibleCrUseOfObjectPool({
              error: Error()
        ...
        spawnNewEnemy(positionX, positionY, id) {
          ...
          const enemy = this.enemyGraphicsTypeToPool.get(enemySettings.graphicsType).borrow();
...
//# sourceMappingURL=893767a8c98ac888b13c34a838c497c89488608d.js.map