    ...
    execute: function () {
      ...
      _export("PlayerCollisionSystem", PlayerCollisionSystem = class PlayerCollisionSystem {
        ...
        onPlayerContactEnd(_selfCollider, otherCollider) {
          const index = this.playerContacts.indexOf(otherCollider);
        ...
        resolveEnemyContact(enemyCollider) {
          const damage = enemyCollider.node.getComponent(_crd && Enemy === void 0 ? (_reportPossibleCrUseOfEnemy({
            error: Error()
          }), Enemy) : Enemy).Damage;
        ...
        resolveEnemyProjectileContact(enemyCollider) {
          const projectile = enemyCollider.node.getComponent(_crd && Projectile === void 0 ? (_reportPossibleCrUseOfProjectile({
            error: Error()
...
//# sourceMappingURL=e9d36551a05cb482b0db2860eba57f786bdd8b1e.js.map