      ...
      _export("EnemyProjectileLauncher", EnemyProjectileLauncher = class EnemyProjectileLauncher {
        ...
        gameTick(deltaTime) {
          ...
          for (const enemyAndTimerPair of this.enemyToTimer) {
            const enemyWorldPosition = enemyAndTimerPair[0].node.worldPosition;
            const shootTimer = enemyAndTimerPair[1];
...
//# sourceMappingURL=20f75c6ade296a9dda600a4fd2fd8b5e845e79bb.js.map