  ...
  return {
    ...
    execute: function () {
      ...
      _export("WaveEnemyMover", WaveEnemyMover = class WaveEnemyMover extends (_crd && EnemyMover === void 0 ? (_reportPossibleCrUseOfEnemyMover({
        ...
        addEnemy(enemy) {
          let direction = new Vec3(); // if the enemy is added soon enough, move as a single group towards one direction
...
//# sourceMappingURL=e167ca5351f53fb9701e753cf9f660cd6c617604.js.map