      ...
      _export("CircularEnemySpawner", CircularEnemySpawner = class CircularEnemySpawner extends (_crd && DelayedEnemySpawner === void 0 ? (_reportPossibleCrUseOfDelayedEnemySpawner({
        ...
        delayedGameTick(deltaTime) {
          ...
          if (this.spawnTimer.tryFinishPeriod()) {
            var angle = 2 * Math.PI / this.enemiesToSpawn;

            for (var i = 0; i < this.enemiesToSpawn; i++) {
              var posX = (_crd && roundToOneDecimal === void 0 ? (_reportPossibleCrUseOfroundToOneDecimal({
                error: Error()
              }), roundToOneDecimal) : roundToOneDecimal)(Math.sin(angle * i)) * 600;
              var posY = (_crd && roundToOneDecimal === void 0 ? (_reportPossibleCrUseOfroundToOneDecimal({
                error: Error()
...
//# sourceMappingURL=587510b57e4fdea487f6d1aa7d66c82e8d0ee079.js.map