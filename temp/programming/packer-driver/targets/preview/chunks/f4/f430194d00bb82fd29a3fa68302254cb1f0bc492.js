    ...
    execute: function () {
      ...
      _export("Player", Player = (_dec = ccclass("Player"), _dec2 = property(BoxCollider2D), _dec3 = property(_crd && PlayerUI === void 0 ? (_reportPossibleCrUseOfPlayerUI({
        ...
        move(deltaTime) {
          ...
          var movement = this.input.getAxis();
        ...
        animateHpChange(hpChange) {
          var _this = this;

          return _asyncToGenerator(function* () {
            if (hpChange < 0) {
              _this.sprite.color = Color.RED;
            } else {
              _this.sprite.color = Color.GREEN;
            }

            yield (_crd && delay === void 0 ? (_reportPossibleCrUseOfdelay({
              error: Error()
            }), delay) : delay)(100);
            _this.sprite.color = Color.WHITE;

            if (!_this.health.IsAlive) {
              _this.animation.play("Die");
            }
          })();
        }
...
//# sourceMappingURL=f430194d00bb82fd29a3fa68302254cb1f0bc492.js.map