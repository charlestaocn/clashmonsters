      ...
      _export("Menu", Menu = (_dec = ccclass("Menu"), _dec2 = property(_crd && UIButton === void 0 ? (_reportPossibleCrUseOfUIButton({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.menuCanvas.cameraComponent = (_crd && AppRoot === void 0 ? (_reportPossibleCrUseOfAppRoot({
              error: Error()
            }), AppRoot) : AppRoot).Instance.MainCamera;

            _this.playBtn.InteractedEvent.on(_this.startGame, _this);

            _this.upgradeBtn.InteractedEvent.on(_this.openUpgradesWindow, _this);

            _this.audioSettingsBtn.InteractedEvent.on(_this.openAudioSettingsWindow, _this);

            _this.menuModalLauncher = new (_crd && MenuModalLauncher === void 0 ? (_reportPossibleCrUseOfMenuModalLauncher({
              error: Error()
            ...
            _this.highscoreLabel.string = "Highscore: " + Math.floor((_crd && AppRoot === void 0 ? (_reportPossibleCrUseOfAppRoot({
              error: Error()
            }), AppRoot) : AppRoot).Instance.LiveUserData.game.highscore);

            _this.updateGoldIndicators();
          })();
        }

        updateGoldIndicators() {
          this.upgradeAvailableIndicator.active = this.isUpgradeAffordable();
          var goldCoins = (_crd && AppRoot === void 0 ? (_reportPossibleCrUseOfAppRoot({
            error: Error()
        ...
        isUpgradeAffordable() {
          ...
          var metaUpgrades = (_crd && AppRoot === void 0 ? (_reportPossibleCrUseOfAppRoot({
            error: Error()
          }), AppRoot) : AppRoot).Instance.LiveUserData.game.metaUpgrades;
          var metaUpgradesSettings = (_crd && AppRoot === void 0 ? (_reportPossibleCrUseOfAppRoot({
            error: Error()
        ...
        openUpgradesWindow() {
          ...
          return _asyncToGenerator(function* () {
            yield _this2.menuModalLauncher.openUpgradesWindow();

            _this2.updateGoldIndicators();
          })();
        }
...
//# sourceMappingURL=1c1c6ad0cbd4c4517c9226c4cf78fe015fc6ae7f.js.map