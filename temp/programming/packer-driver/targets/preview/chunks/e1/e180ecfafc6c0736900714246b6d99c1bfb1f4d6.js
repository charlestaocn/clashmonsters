      ...
      _export("IndividualEnemySpawner", IndividualEnemySpawner = class IndividualEnemySpawner extends (_crd && DelayedEnemySpawner === void 0 ? (_reportPossibleCrUseOfDelayedEnemySpawner({
        ...
        delayedGameTick(deltaTime) {
          ...
          if (this.spawnTimer.tryFinishPeriod()) {
            var posX = randomRange(300, 600) * (_crd && randomPositiveOrNegative === void 0 ? (_reportPossibleCrUseOfrandomPositiveOrNegative({
              error: Error()
            }), randomPositiveOrNegative) : randomPositiveOrNegative)();
            var posY = randomRange(300, 600) * (_crd && randomPositiveOrNegative === void 0 ? (_reportPossibleCrUseOfrandomPositiveOrNegative({
              error: Error()
            }), randomPositiveOrNegative) : randomPositiveOrNegative)();
...
//# sourceMappingURL=e180ecfafc6c0736900714246b6d99c1bfb1f4d6.js.map