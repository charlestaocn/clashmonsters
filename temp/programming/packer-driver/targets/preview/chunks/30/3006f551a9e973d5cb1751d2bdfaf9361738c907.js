    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass("Enemy"), _dec2 = property(BoxCollider2D), _dec3 = property(Sprite), _dec4 = property(Material), _dec5 = property(Material), _dec(_class = (_class2 = class Enemy extends Component {
        ...
        gameTick(move, deltaTime) {
          var newPosition = this.node.worldPosition;
        ...
        animateEndOfLifetime() {
          var _this = this;

          return _asyncToGenerator(function* () {
            if (_this.endOfLifetimeTriggered) return;
            _this.endOfLifetimeTriggered = true;

            while ((_this$node = _this.node) != null && _this$node.active) {
              var _this$node;

              _this.sprite.node.active = false;
              yield (_crd && delay === void 0 ? (_reportPossibleCrUseOfdelay({
                error: Error()
              }), delay) : delay)(200);
              if (_this.sprite == null) break; // exit scene
        ...
        animateHurt() {
          ...
          return _asyncToGenerator(function* () {
            _this2.sprite.material = _this2.whiteMaterial;
            yield (_crd && delay === void 0 ? (_reportPossibleCrUseOfdelay({
              error: Error()
            }), delay) : delay)(100);
            _this2.sprite.material = _this2.defaultMaterial;
          })();
        }
...
//# sourceMappingURL=3006f551a9e973d5cb1751d2bdfaf9361738c907.js.map