    ...
    execute: function () {
      ...
      _export("HaloProjectileLauncher", HaloProjectileLauncher = class HaloProjectileLauncher {
        constructor(launcher, playerNode, settings, projectileData) {
          ...
          var angle = 2 * Math.PI / settings.projectilesToSpawn;

          for (var i = 0; i < settings.projectilesToSpawn; i++) {
            var x = (_crd && roundToOneDecimal === void 0 ? (_reportPossibleCrUseOfroundToOneDecimal({
              error: Error()
            }), roundToOneDecimal) : roundToOneDecimal)(Math.sin(angle * i));
            var y = (_crd && roundToOneDecimal === void 0 ? (_reportPossibleCrUseOfroundToOneDecimal({
              error: Error()
...
//# sourceMappingURL=63edbe03270ad9316d220be4595abf4931a3a5d5.js.map