      ...
      _export("TestGameRunner", TestGameRunner = (_dec = ccclass("TestGameRunner"), _dec2 = property(CCInteger), _dec3 = property(CCInteger), _dec4 = property(CCInteger), _dec5 = property(CCInteger), _dec6 = property(CCInteger), _dec7 = property(CCInteger), _dec8 = property(CCInteger), _dec9 = property(CCInteger), _dec(_class = (_class2 = class TestGameRunner extends Component {
        ...
        playTestGameAsync() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var testUserData = new (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
              error: Error()
            }), UserData) : UserData)();
            testUserData.game.metaUpgrades.healthLevel = _this.maxHpLevel;
            testUserData.game.metaUpgrades.overallDamageLevel = _this.bonusDamageLevel;
            testUserData.game.metaUpgrades.projectilePiercingLevel = _this.projectilePiercingLevel;
            testUserData.game.metaUpgrades.movementSpeedLevel = _this.movementSpeedLevel;
            testUserData.game.metaUpgrades.xpGathererLevel = _this.xpGathererLevel;
            testUserData.game.metaUpgrades.goldGathererLevel = _this.goldGathererLevel;

            var settings = _this.getTimeModifiedSettings((_crd && AppRoot === void 0 ? (_reportPossibleCrUseOfAppRoot({
              error: Error()
            ...
            (_crd && Game === void 0 ? (_reportPossibleCrUseOfGame({
              ...
              startXP: _this.startXP
            });
          })();
        }

        getTimeModifiedSettings(settings) {
          var spawners = [...settings.enemyManager.circularEnemySpawners, ...settings.enemyManager.individualEnemySpawners, ...settings.enemyManager.waveEnemySpawners];
...
//# sourceMappingURL=11c07e3f53c3639f18160b4289dd93ffadd1d11c.js.map