      ...
      _export("AppRoot", AppRoot = (_dec = ccclass("AppRoot"), _dec2 = property(_crd && AudioPlayer === void 0 ? (_reportPossibleCrUseOfAudioPlayer({
        ...
        init() {
          ...
          return _asyncToGenerator(function* () {
            _this.saveSystem = new (_crd && SaveSystem === void 0 ? (_reportPossibleCrUseOfSaveSystem({
              error: Error()
            }), SaveSystem) : SaveSystem)();
            _this.liveUserData = _this.saveSystem.load();
            var gameAssetsNode = instantiate(_this.gameAssetsPrefab);
            gameAssetsNode.setParent(_this.node);
            _this.gameAssets = gameAssetsNode.getComponent(_crd && GameAssets === void 0 ? (_reportPossibleCrUseOfGameAssets({
              error: Error()
            }), GameAssets) : GameAssets);

            _this.gameAssets.init();

            _this.audio.init(_this.LiveUserData.soundVolume, _this.LiveUserData.musicVolume);

            _this.screenFader.init();

            _this.screenFader.node.active = false;
          })();
        }
...
//# sourceMappingURL=87c2b895cf45640bb966410b94a622c1b1618c19.js.map